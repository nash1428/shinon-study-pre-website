...
export default function SearchPage() {
  ...
  return (
    <div className="page-enter px-5 py-6">
      <h1 className="mb-4 text-2xl font-bold text-ink">Search</h1>
      ...
      <div className="relative mb-3">
        ...
        <input
          ...
          className="w-full rounded-2xl border border-stone-200 bg-white py-3.5 pl-11 pr-4 text-sm text-ink placeholder:text-stone-400 focus:border-sage-300 focus:outline-none focus:ring-2 focus:ring-sage-100"
        />
      </div>
