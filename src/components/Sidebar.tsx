...
export default function Sidebar({ activeTab, onTabChange, isCollapsed, onToggleCollapse, profileData }: SidebarProps) {
  ...
  return (
    ...
    >
      ...
      {/* Profile Section — at bottom, pushes nav up when expanded (flex-1 on nav shrinks) */}
      <div className="shrink-0 border-t border-ivory-deep/60">
        {isCollapsed ? (
          ...
          /* Expanded — editable form (grows upward, nav shrinks via flex-1) */
          <div className="overflow-y-auto px-4 pb-4" style={{ animation: "sidebar-expand 0.2s ease-out" }}>
