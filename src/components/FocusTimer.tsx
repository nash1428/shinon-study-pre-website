...
const startMessages = [
  "For the next 25 minutes, let us focus only on this task.",
...
export default function FocusTimer() {
  ...
  const progress = ((isBreak ? BREAK_DURATION : FOCUS_DURATION) - secondsLeft) / (isBreak ? BREAK_DURATION : FOCUS_DURATION);
